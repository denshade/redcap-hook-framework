...
<script type='text/javascript'>
    $(document).ready(function () {
        ...
        $(shazamFields).each(function (i, field_name) {
            ...
            //Initialize value for req & hasval attributes to be added to parent tr
            var shazamFieldRequired = 0;
            var shazamFieldHasValue = 0;
            ...
            // Replace term from note - OBSOLETE
            ...
            $('td.labelrc .shazam', tr).each(function () {
                    ...
                    if (option == 'label') {
                        ...
                        if ($(real_data).size()) {
                            var trInputs = $("input[type!='hidden']", $(real_data)).each(function () {
                                ...
                                if (type == 'text' && $(this).css('width') != '0px')
                                    $(this).css({'width': ''});//,'max-width':'90%'});
                                //limit width of inputs
                                if (type == 'textarea')
                                    $(this).css('width', '95%');
                                //console.log ($(this).css('width'));
                ...
                //req/hasval attribute value of parent tr = req/hasval attribute value of shazammed fields
                shazamFieldRequired = Math.max(shazamFieldRequired, real_tr.attr("req"));
                shazamFieldHasValue = Math.max(shazamFieldHasValue, real_tr.attr("hasval"));
            });

            //Set req/hasval attribute of parent tr
            tr.attr('req', shazamFieldRequired);
            tr.attr('hasval', shazamFieldHasValue);
